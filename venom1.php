<?php
 ...
 if(isset($_GET['logout']))
 {
     ...
     header( "location: venom1.php" );
 }
 ?>
<!DOCTYPE html>
<html>
<head>
	<link rel="stylesheet" type="text/css" href="css/venom1.css">
...
<div id="marvel_logo"><img src="/site/images/logo.jpg" width="5.7%" height="100%">
	...
	<div id="sign_in"><?php  if (!isset($_SESSION['username'])) : ?><b><h5><a href="login.php">SIGN IN</a></h5></b><?php else :?><b><h5><a href="venom1.php?logout='1'">LOGOUT</a></h5></b><?php endif?></div>
...
<div id="ytvid">
	<iframe width="100%" height="935px" src="https://www.youtube.com/embed/xLCn88bfW1o?rel=0;&autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
