...
<div id="butoane">
	...
	<span class="dots"></span> 
	<div id="separator">
		<div id="news1" onclick="currentSlide(1);" style="cursor:pointer;"><b><br>Wilson Fisk Returns</br></b></div>
		<div id="news2" onclick="currentSlide(2);" style="cursor:pointer;"><b><h5>Season 2 | Trailer Part 1</b></h5></div>
		<div id="news3" onclick="currentSlide(3);" style="cursor:pointer;"><b><h5>Season 2 | Trailer Part 2</b></div>
		<div id="news4" onclick="currentSlide(4);" style="cursor:pointer;"><b><h5>Official Trailer | Netflix</br></b></div>
...
<div id="marvel_logo"><img src="/site/images/logo.jpg" width="5.7%" height="100%">
    ...
    <div id="sign_in"><?php  if (!isset($_SESSION['username'])) : ?><b><h5><a href="login.php">SIGN IN</a></h5></b><?php else :?><b><h5><a href="daredevil.php?logout='1'">LOGOUT</a></h5></b><?php endif?></div>
	...
	<div id="horizontal_yellow_bar1">	
			<div id="horizontal_yellow_bar2">
					<div class="slideshow-container">
						...
						<div class="hidden fade">
							<div id="ytvid2">
								<iframe width="1290" height="725" src="https://www.youtube.com/embed/m5_A0Wx0jU4?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
							</div>
						</div>

						<div class="hidden fade">
							<div id="ytvid3">
								<iframe width="1290" height="725" src="https://www.youtube.com/embed/2Cn3DVV0LHY?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
							</div>
						</div>
	
						<div class="hidden fade">
							<div id="ytvid4">
								<iframe width="1290" height="725" src="https://www.youtube.com/embed/jAy6NJ_D5vU?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
							</div>
						</div>
					</div>	
			</div>
...
<div id="dd1"><img src="/site/images/daredevils1.jpg" width="100%" height="100%">
	...
	Kitchen neighborhood as Daredevil, while uncovering <br> a conspiracy of the criminal underworld being led by Wilson Fisk.
...
<div id="poze" class="w3-container">
	...
	<div id="pic1" class="w3-display-container mySlides">
		<img src="/site/images/Daredevil/d1.jpg" style="width:100%">
	</div>

	<div id="pic2" class="w3-display-container mySlides">
		<img src="/site/images/Daredevil/d2.jpg" style="width:100%">
	</div>

	<div id="pic3" class="w3-display-container mySlides">
		<img src="/site/images/Daredevil/d3.jpg" style="width:100%">
	</div>

	<div id="pic4" class="w3-display-container mySlides">
		<img src="/site/images/Daredevil/d4.jpg" style="width:100%">
	</div>
...
<figure id="comic1" class="snip1418"><img src="images/Daredevil/3.jpg" width="250px" height="350px" alt="sample85"/>
...
<figure id="comic2" class="snip1418"><img src="/site/images/Daredevil/6.jpg" width="250px" height="350px" alt="sample85"/>
...
<figure id="comic3" class="snip1418"><img src="/site/images/Daredevil/4.jpg" width="250px" height="350px" alt="sample85"/>
...
<figure id="comic4" class="snip1418"><img src="/site/images/Daredevil/5.jpg" width="250px" height="350px" alt="sample85"/>
...
<figure id="comic5" class="snip1418"><img src="/site/images/Daredevil/1.jpg" width="250px" height="350px" alt="sample85"/>
